...
export default class DateUtils {
  ...
  getPreviousFirstDayOfWeek(date = null, weekStartsOnSunday) {
    ...
    prevFirstDayOfWeek.setDate(
      prevFirstDayOfWeek.getDate() -
        ((prevFirstDayOfWeek.getDay() + dayModifier) % 7)
    );
  ...
  countDays(start, end) {
    ...
    const timezoneDiffMs =
      (new Date(end).getTimezoneOffset() -
        new Date(start).getTimezoneOffset()) *
      60 *
      1000;
